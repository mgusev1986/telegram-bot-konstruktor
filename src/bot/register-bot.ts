    ...
    if (scope === "pay" && action === "check" && value) {
      ...
      if (status.credited) {
        ...
        const statusMap: Record<string, string> = {
          ...
          partially_paid: services.i18n.t(user.selectedLanguage, "deposit_status_partial_human"),
          partially_paid_overpaid: services.i18n.t(user.selectedLanguage, "deposit_status_partial_human"),
          confirming: services.i18n.t(user.selectedLanguage, "deposit_status_pending_human"),
